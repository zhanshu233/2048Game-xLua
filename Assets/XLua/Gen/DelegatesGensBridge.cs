...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void SystemVoid(UnityEngine.EventSystems.BaseEventData arg0)
		{
#if THREAD_SAFT || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new UnityEngine.Events.UnityAction<UnityEngine.EventSystems.BaseEventData>(SystemVoid);
			}
			...
			{
                return new __Gen_Hotfix_Delegate16(XLuaLuaTable);
            }
